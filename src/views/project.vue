...
const desc = [
  {
    description: 'STUDIO 715设计工作室为ILOVEPRETTY设计了全新的店铺空间，<br/>' +
      ...
      '仿佛引领人们来到一个奇妙梦幻的游乐场。',
    location:  'LOCATION：<span style="font-family: STFangsong; font-weight: 550">深圳中心城</span><br/>' +
      'YEAR：2018<br/>' +
  ...
  },
  {
    ...
    location: 'LOCATION： <span style="font-family: STFangsong; font-weight: 550">北京</span><br/>' +
      'YEAR：2018 <br/>' +
  ...
  },
  {
    description: 'WF+鞋履配饰集合店 (World Footwear Plus)是一家<br/>' +
      ...
      '打造一个简约现代的精品形象，<br/>' +
      '凸显产品本身的手工质感以及纯正的色彩。',
    location: 'LOCATION： <span style="font-family: STFangsong; font-weight: 550">北京合生汇</span> <br/>' +
      'YEAR：2018 <br/>' +
      'PHOTOGRAPHY：STUDIO 715'
  },
  {
  ...
  },
  {
    ...
    location: 'LOCATION： <span style="font-family: STFangsong; font-weight: 550">广州、苏州</span> <br/>' +
      'YEAR：2016 <br/>' +
      'PHOTOGRAPHY：STUDIO 715'
  }
]
