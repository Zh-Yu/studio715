...
const desc = [
  {
    description: 'STUDIO 715设计工作室为ILOVEPRETTY设计了全新的店铺空间，<br/>' +
      ...
      '同时空间中大量运用新奇有趣的几何元素：如整面墙的折线形墙板随着<br/>' +
      '人的移动而形成不同的光影效果；具有积木形态的几何中岛，撞色的设<br/>' +
      '计颇具视觉冲击力，<br/>' +
      '仿佛引领人们来到一个奇妙梦幻的游乐场。',
  ...
  {
    description: 'WF+鞋履配饰集合店 (World Footwear Plus)是一家以意大利手工皮鞋品牌<br/>' +
      '以及高端私人定制为主，融合了时尚服饰、配饰的生活体验馆。<br/>' +
  ...
  },
  {
    description: 'STUDIO 715为鞋履配饰品牌集合店 WF+ （World Footwear Plus）展厅设计了全新的陈列展示。<br/>' +
      '整体陈列风格以现代感极强的几何色块为主，搭配家具简洁流畅的线条，搭建出几种色彩主题的陈列背景。<br/>' +
      '每个场景利用墙面层板、小沙发、地毯、边桌等软装家具作为鞋履陈列的承载物，<br/>' +
  ...
  },
  {
    ...
    '为体现其年轻、时尚、优雅、高级的服装品质，我们采用了来自意大利的Arabescato Corchia（网纹大花白）<br/>' +
